output "dds_instance_id" {
  ...
  value       = module.mongodb_cluster.dds_instance_id
}

output "dds_instance_name" {
  description = "The DDS instance name"
  value       = module.mongodb_cluster.dds_instance_name
}

output "dds_instance_status" {
  description = "The DDS instance status"
  value       = module.mongodb_cluster.dds_instance_status
}

output "dds_instance_port" {
  description = "The database port"
  value       = module.mongodb_cluster.dds_instance_port
}
